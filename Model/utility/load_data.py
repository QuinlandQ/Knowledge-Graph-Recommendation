...
class Data(object):
    def __init__(self, args, path):
        ...
        self.lstm_input_size = args.input_size

        #train_file = path + '/train.txt'
        #test_file = path + '/test.txt' "E:\360MoveData\Users\ADMIN\Desktop\Knowledge Graph Recommendation\Data\recipe\relation_list.txt"
        #kg_file = path + '/kg_final.txt'
        # records_file = path + '/records.txt'
        train_file = 'E:\桌面\Knowledge Graph Recommendation\Data/recipe/train.txt'
        test_file = 'E:\桌面\Knowledge Graph Recommendation\Data/recipe/test.txt'
        kg_file ='E:\桌面\Knowledge Graph Recommendation\Data/recipe/kg_final.txt'
        records_file = 'C:/Users/ADMIN/Desktop/Knowledge Graph Recommendation/Data/recipe/records.txt'
        ...
        self.train_records = self.load_records(train_file)
        self.test_records = self.load_records(test_file)

        self.n_relations, self.n_entities, self.n_triples = 0, 0, 0
        self.kg_data, self.kg_dict, self.relation_dict = self.load_kg(kg_file)
    ...
    def load_kg(self, file_name):
        ...
        kg_np = np.unique(kg_np, axis=0)  # 去除三元组中的重复行
    ...
    def generate__train_lstm_batch(self):
        train_batch_data = {}
        ...
        for u in users:
            ...
            train_records = self.train_records[str(u)]
            train_batch_data[u] = train_records
